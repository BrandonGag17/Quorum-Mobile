        ...
        {modoHistorial ? (
          ...
          <View style={styles.tabsContainer}>
            <Pressable
              ...
              style={[
                styles.tabButton,
                pestanaActiva === "actual" && styles.tabButtonActive,
              ]}
            >
              <Text
                style={[
                  styles.tabText,
                  pestanaActiva === "actual" && styles.tabTextActive,
                ]}
              >
                Actual
              </Text>
            ...
            <Pressable
              ...
              style={[
                styles.tabButton,
                pestanaActiva === "historial" && styles.tabButtonActive,
              ]}
            >
              <Text
                style={[
                  styles.tabText,
                  pestanaActiva === "historial" && styles.tabTextActive,
                ]}
              >
                Historial
              </Text>
              ...
              {!loading && gastos.length === 0 ? (
                <View style={styles.emptyState}>
                  ...
                  <Text style={styles.emptySubtitle}>
                    Cuando alguien agregue un gasto, aparecerá acá y se sumará
                    al total.
                  </Text>
                </View>
              ) : (
                <View>
                  {gastosPorPersona
                    ...
                    .map((resumen) => {
                      const estaExpandida =
                        personaExpandidaId === resumen.persona.id;

                      return (
                        <View
                          key={resumen.persona.id}
                          style={styles.personaItem}
                        >
                          <Pressable
                            onPress={() =>
                              alternarDetallePersona(resumen.persona.id)
                            }
                            ...
                            <View style={styles.personaInfo}>
                              ...
                              <Text style={styles.personaName}>
                                {resumen.persona.nombre ||
                                  resumen.persona.username ||
                                  "Persona"}
                              </Text>
                            </View>
                            <View style={styles.personaRight}>
                              <Text style={styles.personaTotal}>
                                {formatearMonto(resumen.total)}
                              </Text>
                              <Ionicons
                                name={
                                  estaExpandida ? "chevron-up" : "chevron-down"
                                }
                                size={18}
                                color="#B8B8C5"
                              />
                            ...
                            <View style={styles.gastoList}>
                              {resumen.gastos.map((gasto) => (
                                <View key={gasto.id} style={styles.gastoItem}>
                                  <Text style={styles.gastoDescription}>
                                    {gasto.descripcion}
                                  </Text>
            ...
            {historial.length === 0 ? (
              ...
              <View style={styles.historialList}>
                {historial.map((evento) => (
                  ...
                  >
                    <View>
                      <Text style={styles.historialEventName}>
                        {evento.nombre}
                      </Text>
                      <Text style={styles.historialEventDate}>
                    ...
                    <View style={styles.historialRight}>
                      <View style={styles.historialAvatars}>
                        ...
                        {evento.personas.length > 3 && (
                          <View
                            style={[styles.smallAvatar, styles.moreAvatars]}
                          >
      ...
      >
        <View style={styles.modalOverlay}>
          <View style={styles.modalContent}>
            ...
            <ScrollView
              style={styles.personasPickerContainer}
              nestedScrollEnabled
            >
                ...
                <Pressable
                  ...
                  style={[
                    ...
                    pagadorSeleccionado?.id === persona.id &&
                      styles.personaPickerItemSelected,
                  ]}
                >
                  <Image
                    source={{
                      uri:
                        persona.foto_perfil || "https://via.placeholder.com/40",
                    }}
